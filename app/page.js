...
export default function Home() {
  ...
  return (
    <main className="bg-slate-300 rounded-md dark:bg-slate-800">
      ...
      <div className="flex justify-center gap-4 mt-4">
        <button onClick={() => setCategory("all")} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
          All
        </button>
        <button onClick={() => setCategory("music")} className="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
          Music
        </button>
